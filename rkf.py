...
import youtube_dl
#SELFBOT
cl = LineClient(authToken='EFseDmzZ6yjHKRz7X0e0.FlW67sTIW08iQ1koFcSwOa.eRbE4dyHK0MhPrEXlCVM86NsVHd0f7d+11QWC3XYBRw=')
...
poll = LinePoll(cl)
call = cl
creator = ['u7cbc3aed2b62c34f08ab528e7c2b16a0']
owner = ["u7cbc3aed2b62c34f08ab528e7c2b16a0",'u07ab860849ffd84c6052f57f3fe351a4']
admin = ["u7cbc3aed2b62c34f08ab528e7c2b16a0","u07ab860849ffd84c6052f57f3fe351a4"]
staff = ["u7cbc3aed2b62c34f08ab528e7c2b16a0"]
...
wait = {
    ...
    "selfbot":True,
    "mention":"hulika 😊",
    "Respontag":"ANO PROBLEMA MO",
    "welcome":"Selamat datang & semoga betah",
    "comment":"Like like & like by RICKY",
    "message":"THANKS FOR ADD ME 🙏🙏ADD MY OFFICIAL ACC (itu)http://line.me/ti/p/rickyboywe",
    }
                 ...
                 if wait["detectMention"] == True:
                   ...
                   for mention in mentionees:
                        if mention ['M'] in Bots:
                           ...
                           cl.sendMessage(msg.to, None, contentMetadata={"STKID":"20506069","STKPKGID":"1605952","STKVER":"1"}, contentType=7)
                           break
               if 'MENTION' in msg.contentMetadata.keys() != None:
               ...
               if msg.contentType == 13:
                 ...
                 if wait["dellbots"] == True:
                    if msg.contentMetadata["mid"] in Bots:
                        ...
                        wait["dellbots"] = True
                        cl.sendMessage(msg.to,"Contact itu bukan anggota bot Rkf")
#ADD STAFF
                 if msg._from in admin:
                        ...
                        if cmd == "help":
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               ...
                               cl.sendContact(to, "ud6ce0750a25ff0ce5a0d899eb8602927")                                     
                        ...
                        if cmd == "self on":
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               ...
                               cl.sendContact(to, "u385fa1b36365fb3e4c10bc5df696adc0")
                          ...
                          if wait["selfbot"] == True:
                            ...
                            if msg._from in admin:
                                cl.sendText(msg.to,"Creator Bot RKF") 
                                ma = ""
                                for i in creator:
                                    ma = cl.getContact(i)
...
#===========BOT UPDATE============#
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                cl.sendMessage(msg.to, "❧RĶF Speed respon\n\n - Get Profile\n   %.10f\n - Get Contact\n   %.10f\n - Get Group\n   %.10f" % (get_profile_time/3,get_contact_time/3,get_group_time/3))
                          ...
                          if wait["selfbot"] == True:
                           if msg._from in admin:
                              try:
                                  tz = pytz.timezone("Asia/Jakarta")
                                  timeNow = datetime.now(tz=tz)
                                  cl.sendMessage(msg.to, "ok mahalko\n\nTanggal : "+ datetime.strftime(timeNow,'%Y-%m-%d')+"\nJam [ "+ datetime.strftime(timeNow,'%H:%M:%S')+" ]")
                          ...
                          if wait["selfbot"] == True:
                           if msg._from in admin:
                              if msg.to in cctv['point']:
                                  ...
                                  cl.sendMessage(msg.to, "already off mahalko\n\nTanggal : "+ datetime.strftime(timeNow,'%Y-%m-%d')+"\nJam [ "+ datetime.strftime(timeNow,'%H:%M:%S')+" ]")
                              else:
...
#===========KICKOUT============#
                        ...
                        elif "Clean" in msg.text:
                            if msg._from in admin:
                             if msg.toType == 2:
                                 print ("[ 19 ] KICK ALL MEMBER")
                                 _name = msg.text.replace("Clean","")
                                 gs = cl.getGroup(msg.to)
                                 cl.sendMessage(msg.to,"「 permision to rak 」")
                                 cl.sendMessage(msg.to,"「 FUCK YOU ALL」")
                                 targets = []
                                 for g in gs.members:
...
#===========COMMAND ON OFF============#
                        ...
                        elif cmd == "lusinyorespon on" or text.lower() == 'lusinyorespon on':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["detectMention"] = True
                                cl.sendText(msg.to,"Auto respon diaktifkan")

                        elif cmd == "lusinyorespon off" or text.lower() == 'lusinyorespon off':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["detectMention"] = False
                                cl.sendText(msg.to,"Auto respon dinonaktifkan")

                        elif cmd == "lusinyoautojoin on" or text.lower() == 'lusinyoautojoin on':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["autoJoin"] = True
                                cl.sendText(msg.to,"Autojoin diaktifkan")

                        elif cmd == "lusinyoautojoin off" or text.lower() == 'lusinyoautojoin off':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["autoJoin"] = False
                                cl.sendText(msg.to,"Autojoin dinonaktifkan")

                        elif cmd == "lusinyoautoleave on" or text.lower() == 'lusinyoautoleave on':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["autoLeave"] = True
                                cl.sendText(msg.to,"Autoleave diaktifkan")

                        elif cmd == "lusinyoautoleave off" or text.lower() == 'lusinyoautoleave off':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["autoLeave"] = False
                                cl.sendText(msg.to,"Autoleave dinonaktifkan")

                        elif cmd == "lusinyoautoadd on" or text.lower() == 'lusinyoautoadd on':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["autoAdd"] = True
                                cl.sendText(msg.to,"Auto add diaktifkan")

                        elif cmd == "lusinyoautoadd off" or text.lower() == 'autoadd off':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["autoAdd"] = False
                        ...
                        elif cmd == "lusinyosticker on" or text.lower() == 'lusinyosticker on':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["sticker"] = True
                                cl.sendText(msg.to,"Deteksi sticker diaktifkan")

                        elif cmd == "lusinyosticker off" or text.lower() == 'lusinyosticker off':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["sticker"] = False
                            ...
                            if msg._from in admin:
                              if wait["blacklist"] == {}:
                                ...
                                for m_id in wait["blacklist"]:
                                    ...
                                    ma += str(a) + ". " +cl.getContact(m_id).displayName + "\n"
                                cl.sendMessage(msg.to,"❧RKF Blacklist User\n\n"+ma+"\nTotal「%s」Blacklist User" %(str(len(wait["blacklist"]))))
                            ...
                            if msg._from in admin:
                              if wait["Talkblacklist"] == {}:
                                ...
                                for m_id in wait["Talkblacklist"]:
                                    ...
                                    ma += str(a) + ". " +cl.getContact(m_id).displayName + "\n"
                                cl.sendMessage(msg.to,"❧RĶF Talkban User\n\n"+ma+"\nTotal「%s」Talkban User" %(str(len(wait["Talkblacklist"]))))
